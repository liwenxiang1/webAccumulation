...
export default {
  ...
  data() {
    return {
      defaultOffset: 100, // 默认高度, 相应的修改.releshModule的margin-top和.down-tip, .up-tip, .refresh-tip的height
      top: 0,
      scrollIsToTop: 0,
      startY: 0,
